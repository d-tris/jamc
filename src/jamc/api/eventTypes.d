...
/** Reprezentuje cokoliv stisknutelneho (klavesy, tlacitka mysi, 
 *  v budoucnu mozna i tlacitka joysticku)
 *  Prevzato z SFML sfKeyCode a sfMouseButton
 */
enum Key
{
    A,            ///< The A key
...
{
    this( vec2i position, vec2i delta )
    {
        this.position = position;
        this.delta = delta;
    }
